//! Methods for modifying terms to account for binders and level parameters
...
impl TypedTerm {
    /// Replaces all instances of bound variable `id` with `expr`, while adjusting indices so that
    /// they still reference the same variables
    #[must_use]
    ...
    /// Increments all bound variable indices in the term with index greater than `limit` by `inc`
    #[must_use]
    ...
    /// Instantiates all level parameters in the term using the given `level_args`
    #[must_use]
    ...
    /// Replaces the term's abbreviation with the one given
    #[must_use]
    ...
    /// Replaces the term's abbreviation with the abbreviation from another term
    #[must_use]
    ...
    /// Clears the term's abbreviation
    #[must_use]
    ...
    /// [Normalizes] the term's level
    ///
    /// [Normalizes]: crate::typeck::level::Level::normalize
    #[must_use]
...
impl TypedTermKind {
    ...
    /// Replaces the term's abbreviation with the optional one given. If the argument is `None`,
    /// clears the term's abbreviation.
    #[must_use]
...
impl Abbreviation {
    ...
    /// Increments all bound variable indices in the abbreviation with index greater than `limit` by `inc`
    #[must_use]
    ...
    /// Instantiates all level parameters in the abbreviation using the given `level_args`
    #[must_use]
...
impl TypedBinder {
    ...
    /// Increments all bound variable indices in the binder with index greater than `limit` by `inc`
    #[must_use]
    ...
    /// Instantiates all level parameters in the binder using the given `level_args`
    #[must_use]
